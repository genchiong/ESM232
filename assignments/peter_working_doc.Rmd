...
discount_vec = runif(min=base_discount-deviation*base_discount,
                max = base_discount+deviation*base_discount, n=nsamples)

params <- tibble(a = a_vec, c = c_vec, price = price_vec, discount = discount_vec)
...
price_plot / discount_plot | a_plot / c_plot
```
